...
FindNearestValue.bas is the excel module file, import it to the macro enabled excel sheet either by importing it or create a module and copy and paste the code. Some ways to execute the macro include running the FindNearestValue macro or creating a shape button and assigning the macro to that shape shown below.
